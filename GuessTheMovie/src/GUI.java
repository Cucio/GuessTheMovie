...
public class GUI extends JPanel implements ActionListener {
    ...
    private void arrangeComponents() {
        ...
        labelText = new JLabel("Introdu o singura litera: ");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button1) {
            if (gameStarted)
                if (newGame.checkIfWon()) {
                    ...
                    if (!textField.getText().equals("")) {
                        ...
                        textField.setText("");
                        newGame.verify(lit);
                        labelGresite.setText(newGame.getWrongAttemptsArray());
                        labelFilm.setText(newGame.getMovieName());
                        if (!newGame.getValidLetter()) labelError.setText("Introdu o litera valida!");
                        else if (newGame.wasIntroduced())
            ...
            switch (newGame.getWrongAttempts()) {
                case 1:
                ...
                case 7: {
                    ...
                    JOptionPane.showMessageDialog(frame, "Ai pierdut! Cuvantul era: " + "'" + newGame.movieName + "'");
                    System.exit(0);
                }
            }
